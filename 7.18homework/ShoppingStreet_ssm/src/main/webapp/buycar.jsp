    ...
    <div class="content mar_20">
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0"
            ...
            <tr>
                ...
                <td align="center" style="color:#ff4e00;">￥<%=product.getPrice()%>
                </td>
                <td align="center">26R</td>
                <td align="center"><a onclick="ShowDiv('MyDiv','fade')">删除</a>&nbsp; &nbsp;<a
                        href="#">加入收藏</a></td>
            </tr>
            <%
                    }
            ...
            <tr height="70">
                <td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                    ...
                    <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥<%=session
                            .getAttribute("sum")%></b></span>
                </td>
            </tr>
            <tr valign="top" height="150">
                <td colspan="6" align="right">
                    <a href="#"><img src="images/buy1.gif"/></a>&nbsp; &nbsp; <a href="confirm"><img
