...
<div class="soubg">
    <div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="Login.jsp">登录</a>&nbsp; <a href="Regist.html"
            ...
            <form action="regist" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;"
                    ...
                    <tr height="50">
                        ...
                        <td id="tdloginName"><input type="text" id="loginName" name="loginName"
                                                    value=""
                                                    class="l_user"/></td>
                    </tr>
                    <tr height="50">
...
<%--                                .equals(session.getAttribute("confim")))) {--%>
...
<%--                    %>--%>
                	...
                	<span style="font-family:'宋体';" class="fl">
                    	<label class="r_rad"><input type="checkbox" name="checkbox"/></label><label
