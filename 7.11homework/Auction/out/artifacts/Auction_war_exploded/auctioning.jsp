...
<div class="wrap">
    ...
    <%
        Auction_item itemById = (Auction_item) session.getAttribute("itemById");
    %>
    ...
    <div class="items sg-font lf">
        <ul class="rows">
            <li>名称：</li>
            <li class="borderno"><%=itemById.getItem_name()%></li>
        </ul>
        <ul class="rows">
            <li>描述：</li>
            <li class="borderno"><%=itemById.getDescription()%></li>
        </ul>
        <ul class="rows">
            <li>开始时间：</li>
            <li class="borderno"><%=itemById.getStart_time()%></li>
        </ul>
        <ul class="rows">
            <li>结束时间：</li>
            <li class="borderno"><%=itemById.getEnd_time()%></li>
        </ul>
        <ul class="rows border-no">
            <li>起拍价：</li>
            <li class="borderno"><%=itemById.getStarting_price()%></li>
        </ul>
    </div>
