...
<div class="wrap">
    ...
    <div class="items">
        ...
        <%
            Object allitems = session.getAttribute("allitems");
            if (allitems!=null){
                List<Auction_item> auctionItemList = (List<Auction_item>) allitems;
                for (Auction_item auction_item : auctionItemList) {
                    out.print("<ul class=\"rows\">\n"
                            + "            <li><a href=\"#\" title=\"\">"+auction_item.getItem_name()+"</a></li>\n"
                            + "            <li class=\"list-wd\">"+auction_item.getDescription()+"</li>\n"
                            + "            <li>"+auction_item.getStart_time()+"</li>\n"
                            + "            <li>"+auction_item.getEnd_time()+"</li>\n"
                            + "            <li>"+auction_item.getStarting_price()+"</li>\n"
                            + "            <li class=\"borderno red\">\n"
                            + "                <a href=\"Modify_items.jsp?id2="+auction_item.getId()+"\" title=\"竞拍\" onclick=\"dele();\">修改</a>|\n"
                            + "                <a href=\"delete.do?id="+auction_item.getId()+"\"  title=\"竞拍\" onclick=\"abc();\">删除</a>|\n"
                            + "                <a href=\"Add_items.jsp\" title=\"竞拍\" onclick=\"abc();\">增加</a>\n"
                            + "            </li>\n"
                            + "        </ul>");
                }
