...
<div class="wrap">
    ...
    <div class="login logns produce">
        ...
        <form action="modify.do?id=<%=request.getParameter("id2")%>">
            <dl>
                <dd >
                    <label>名称：</label>
                    <input type="text" name="item_name" class="inputh lf" value="名称" />
                    <div class="xzkbg spbg lf"></div>
                </dd>
                <dd>
                    <label>起拍价：</label>
                    <input type="text" name="starting_price" class="inputh lf" value="4000,00" />
                    <div class="lf red laba">必须为数字</div>
                </dd>
                <dd>
                    <label>底价：</label>
                    <input type="text" name="base_price" class="inputh lf" value="5000.00" />
                    <div class="lf red laba">必须为数字</div>
                </dd>
                <dd>
                    <label>开始时间：</label>
                    <input type="text" name="start_time" class="inputh lf" value="2010-01-05 12:30:00" />
                    <div class="lf red laba">格式：2011-05-05 12:30:00</div>
                </dd>
                <dd>
                    <label>结束时间：</label>
                    <input type="text" name="end_time" class="inputh lf" value="2010-05-06 12:30:00" />
                    <div class="lf red laba">格式：2011-05-05 12:30:00</div>
                </dd>
                <dd class="dds">
                    <label>描述：</label>
