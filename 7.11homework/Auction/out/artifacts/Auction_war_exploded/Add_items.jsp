    ...
    <div class="login logns produce">
        ...
        <form action="add.do">
            <dl>
                <dd >
                    <label>名称：</label>
                    <input type="text" class="inputh lf" name="item_name" value="" />
                    <div class="xzkbg spbg lf"></div>
                </dd>
                <dd>
                    <label>起拍价：</label>
                    <input type="text" class="inputh lf" name="starting_price" value="" />
                    <div class="lf red laba">必须为数字</div>
                </dd>
                <dd>
                    <label>底价：</label>
                    <input type="text" class="inputh lf" name="base_price" value="" />
                    <div class="lf red laba">必须为数字</div>
                </dd>
                <dd>
                    <label>开始时间：</label>
                    <input type="text" class="inputh lf" name="start_time" value="" />
                    <div class="lf red laba">格式：2010-05-05 12:30:00</div>
                </dd>
                <dd>
                    <label>结束时间：</label>
                    <input type="text" class="inputh lf" name="end_time" value="" />
