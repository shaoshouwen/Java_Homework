...
<div class="wrap">
    ...
    <div class="items">
        ...
        <%
            Object object = session.getAttribute("allitems");
            Object object1 = session.getAttribute("itemByName");
            if (object != null && object1 == null) {
                ...
                for (Auction_item auction_item : auctionItemList) {
                    out.print("<ul class=\"rows\">\n"
                            ...
                            + "            <li class=\"borderno red\"><a href=\"auction.do?id="+auction_item.getId()+"\">竞拍</a></li>\n"
                            + "        </ul>");
                }
            }
            if (object1 != null) {
